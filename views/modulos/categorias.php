                            ...
                            <div class="card-header">
                                <div class="animation-model">
                                    <button type="button" class="btn btn-inverse btn-outline-default waves-effect md-trigger btnNuevoUser" data-modal="modalRegistrarCategoria" >
                                        <i class="icofont icofont-user-alt-3"></i> Nueva categoria
                                    </button>
                                    <!-- modal -->
                                            ...
                                            <div class="md-content" >
                                                ...
                                                <div >
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12 col-lg-10">
                                                            <div class="input-group input-group-inverse">
                                                                <input class="form-control input-md" type="text" name="nombresUser" placeholder="Ingresar nombre de la categoria" required>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12 col-lg-10">
                                                            <div class="input-group input-group-inverse">
                                                                <textarea rows="5" cols="5" class="form-control" placeholder="Descripción de la categoria"></textarea>
                                                            </div>
                                                        </div>      
                                                    </div>
                                                    <div class="row">
                                                        <label class="col-sm-8 col-lg-2 col-form-label">estado:</label>
                                                        <div class="col-sm-12 col-lg-10 border-checkbox-section">
                                                            <div class="border-checkbox-group border-checkbox-group-primary">
                                                                <input class="border-checkbox" type="checkbox" id="checkbox1" checked>
                                                                <label class="border-checkbox-label" style="font-size:0.9em" for="checkbox1">Categoria activa</label>
                                                            </div>
                                                        </div>      
                                                    </div>
